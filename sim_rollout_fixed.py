...
def main() -> None:
    ...
    parser.add_argument("--json", default="data/train/data_8_fixed.json", help="Path to the static JSON data.")
    parser.add_argument("--run-id", default="pengxiang_test_0824_fixed", help="Run ID to write into DB rows.")
    ...
    parser.add_argument("--loops", type=int, default=100000, help="Maximum number of full loops over the JSON (default: 10).")
