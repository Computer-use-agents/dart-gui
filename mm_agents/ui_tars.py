        ...
        if action_type == "hotkey":
            ...
            if start_box:
                ...
                if start_box is None:
                    print(f"[Warning] start_box is None and wired condition:\n{action_inputs}")
...
class UITARSAgent:
    def __init__(
        ...
        self.vlm = OpenAI(
            base_url="https://sv-84202af9-22ce-4776-8ce0-43f750b345ee-8000-x-aps-o-e7d0cab77e.sproxy.hd-01.alayanew.com:22443/v1",
            api_key="empty",
        ...
        self.prompt_template = COMPUTER_USE_DOUBAO
    ...
    def predict(
        ...
        while True:
            ...
            try:
                ...
                print(f"Error when parsing response from client, with response: {response}; error: {e}")
