...
export NCCL_SOCKET_IFNAME=eth0        # 只走 IB 口，防止走到以太网
export NCCL_IB_DISABLE=0             # 1=禁用IB，0=启用
export NCCL_IB_HCA=mlx5_0,mlx5_3,mlx5_4,mlx5_5,mlx5_6,mlx5_7,ib6s200p0,ib7s400p0,ib7s400p1 # 按 ibstat 实际端口填
